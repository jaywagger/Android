...
public class TabTest2 extends AppCompatActivity {
    TabLayout tabLayout;
    ViewPager pager;
    //프레그먼트를 담을 ArrayList 필요함
    ArrayList<Fragment> fragmentArrayList = new ArrayList<Fragment>();
    //탭 문자열을 담을 ArrayList 필요함
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //TabLayout과 ViewPager를 연결 - ViewPager의 getPageTitle 메소드를
        //호출해서 탭의 문자열을 셋팅
    ...
    class PagerAdapter extends FragmentStatePagerAdapter{
        ...
        //뷰페이저와 탭을 연결하기 위해서는 탭에 출력될 문자열을 만들어내는 메소드
        //탭에 연결된 문자열을 보여주는 메서드
        @Nullable
        @Override
